/* Creacion de un usuario para el curso con nombre de usuario PEPERF con contrase�a PEPITO y asignacion de permisos */
/* Los datos de usuario y contrase�a pueden ser variados por el alumno si lo desea */
CREATE USER PEPERF IDENTIFIED BY PEPITO;
GRANT CONNECT, RESOURCE TO PEPERF;
GRANT CREATE VIEW TO PEPERF;
ALTER USER PEPERF DEFAULT TABLESPACE USERS;
ALTER USER PEPERF QUOTA UNLIMITED ON USERS;
/
---Creas la conexion y ejecutas lo siguiente
/*Drops para cambios
DROP TABLE DEPARTAMENTO;
DROP TABLE DEPARTAMENTO_EMPLEADO;
DROP TABLE DOCTOR;
DROP TABLE DOCTOR_HOSPITAL;
DROP TABLE EMPLEADO;
DROP TABLE EMPLEADO_HOSPITAL;
DROP TABLE ENFERMO;
DROP TABLE ESTADOS_CIVILES;
DROP TABLE HOSPITAL
DROP TABLE HOSPITAL_ENFERMO;
DROP TABLE PERSONA;
DROP TABLE PLANTILLA;
DROP TABLE PLANTILLA_SALA;
DROP TABLE SALA;
*/
...
CREATE TABLE PLANTILLA
 ...
 ,CONSTRAINT AVCON_1247567854_TURNO_000 CHECK (TURNO IN ('M','T','N')))
/
...
CREATE TABLE PLANTILLA_SALA
 ...
 ,CONSTRAINT PLAN_SALA_PK PRIMARY KEY (PLAN_NIF,SALA_CODIGO,SALA_HOSP_CODIGO)
 ,CONSTRAINT PLAN_SALA_SALA_FK FOREIGN KEY (SALA_CODIGO,SALA_HOSP_CODIGO) REFERENCES SALA (CODIGO,HOSP_CODIGO)
...
CREATE TABLE HOSPITAL_ENFERMO
 ...
 ,FINSCRIPCION DATE
 ,CONSTRAINT HOSP_ENF_PK PRIMARY KEY (INSCRIPCION,HOSP_CODIGO,ENF_NUMSEGSOCIAL)
...
CREATE TABLE DOCTOR_HOSPITAL
 ...
 ,CONSTRAINT DOC_HOSP_PK PRIMARY KEY (DOC_NIF,HOSP_CODIGO)
...
CREATE TABLE EMPLEADO_HOSPITAL
 ...
 ,CONSTRAINT EMP_HOSP_PK PRIMARY KEY (EMP_NIF,HOSP_CODIGO)
...
CREATE TABLE DEPARTAMENTO_EMPLEADO
 ...
 ,EMP_NIF VARCHAR2(9) NOT NULL
 ,CONSTRAINT DEPT_EMP_PK PRIMARY KEY (EMP_NIF,DEPT_CODIGO)
...
INSERT INTO hospital
values (5,'915971500','Gr. Mara�on',300,'Francisco Silvela');
...
INSERT INTO doctor
VALUES ('12345678J','Gutierrez T.','I�aqui','Cardiologia');
...
INSERT INTO doctor
VALUES ('22345678J','Lopez T.','I�aqui','Cardiologia');
...
INSERT INTO doctor
VaLUES ('42345678K','Torres B.','To�in','Ginecologia');
